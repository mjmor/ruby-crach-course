...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # Injects an aggregation method into the array.
    # I.e. apply the input function to each element of the array cummulatively.
  end
  ...
  #   # code to read 'file'
  #
  # The end terminator destroys the 'file' variable, thus closing the
  # file handle in the OS.
  #
