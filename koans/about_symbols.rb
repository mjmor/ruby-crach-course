...
class AboutSymbols < Neo::Koan
  ...
  #
  # that would be true since just executing :test_method_names_become_symbols
  # would create the symbol instance.
  ...
  #
  # Because the symbols may conflict and overwrite one another.
  # Also, they pollute the memory pool and namespace.
end
